    ...
    <div>
      <nav className="flex items-center justify-between flex-wrap bg-black p-3">
        <div className="flex items-center space-x-1 flex-shrink-0 text-white mr-6">
          ...
          <span className="block mt-2 font-bold text-2xl font-serif cursor-pointer lg:inline-block lg:mt-0 text-white hover:text-white mr-4">NoteBook</span>
        </div>
        <div className="w-full block flex-grow  lg:flex lg:items-center lg:w-auto">
          <div className="text-sm lg:flex-grow">
            <Link to="/" className="block mt-2 font-bold text-xl font-serif lg:inline-block lg:mt-0 text-white hover:text-white mr-4">
              Home
            </Link>
            <Link to="/about" className="block mt-2 font-bold text-xl font-serif lg:inline-block lg:mt-0 text-white hover:text-white mr-4">
              About
            </Link>
            <Link to="#responsive-header" className="block mt-2 text-xl font-bold font-serif lg:inline-block lg:mt-0 text-white hover:text-white">
              Blog
            </Link>
          </div>
          <div>
          ...
          <label for="teal-toggle" className="inline-flex relative items-center mr-1 cursor-pointer">
